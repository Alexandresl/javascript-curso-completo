 ...
 * 
 * Irá conter as regras de negócio
 * 
 */
...
class CalcController {
    ...
    /**
     * Método executado assim que a calculadora é iniciada
     */
    ...
    setDisplayDateTime() {
        ...
        this.displayDate = new Date().toLocaleDateString(this.toLocale, {
            day: "2-digit",
            month: "long",
            year: "numeric"
        });
        this.displayTime = new Date().toLocaleTimeString(this.toLocale);
