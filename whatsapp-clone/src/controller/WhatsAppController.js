...
export class WhatsAppController {
                        ...
                        <div class="_1AwDx">
                            <div class="_itDl">
                                ...
                                <span class="_2_LEW last-message">
                                    ...
                                    <span dir="ltr" class="_1wjpf _3NFp9">${(contact.lastMessage) ? contact.lastMessage : ''}</span>
                                    <div class="_3Bxar">
                                        <span>
                                            <div class="_15G96">
    ...
    initEvents() {
        ...
        this.el.inputNamePanelEditProfile.on('click', e => {
            ...
            if (this.el.inputNamePanelEditProfile.innerHTML === 'Meu Nome de Contato') this.el.inputNamePanelEditProfile.innerHTML = '';

        });

        this.el.inputNamePanelEditProfile.on('focusout', e => {

            if (this.el.inputNamePanelEditProfile.innerHTML === '') this.el.inputNamePanelEditProfile.innerHTML = 'Meu Nome de Contato';
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            ...
            emoji.on('click', e => {
                ...
                img.dataset.unicode = emoji.dataset.unnicode;
